...
public static partial class GGPO {
    ...
    [DllImport(libraryName)]
    static extern void UggSetLogDelegate(IntPtr callback);
    ...
    [DllImport(libraryName)]
    static extern int UggStartSyncTestSession(out IntPtr session,
        IntPtr beginGame,
        IntPtr advanceFrame,
        IntPtr loadGameState,
        IntPtr logGameState,
        ...
        IntPtr freeBuffer,
        IntPtr onEvent,
        string game, int num_players, int rollbackAmount);
    ...
    public static int StartSyncTestSession(out IntPtr session,
        IntPtr beginGame,
        IntPtr advanceFrame,
        IntPtr loadGameState,
        IntPtr logGameState,
        ...
        string game, int num_players, int rollbackAmount)
    {
        return UggStartSyncTestSession(out session, beginGame, advanceFrame, loadGameState, logGameState, saveGameState, freeBuffer, onEvent, game, num_players, rollbackAmount);
    }
