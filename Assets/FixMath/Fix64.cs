...
namespace FixMath.NET
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        public static readonly Fix64 Maxue = new Fix64(MAX_VALUE);
        public static readonly Fix64 MinValue = new Fix64(MIN_VALUE);
        public static readonly Fix64 One = new Fix64(ONE);
        public static readonly Fix64 Zero = new Fix64();
        public static readonly Fix64 Tenth = new Fix64(1) / new Fix64(10);
        public static readonly Fix64 Ten = new Fix64(10);
        public static readonly Fix64 Five = new Fix64(5);
        public static readonly Fix64 Hundred = new Fix64(100);
        public static readonly Fix64 Two = new Fix64(2);
        public static readonly Fix64 Half = new Fix64(1) / new Fix64(2);
        public static readonly Fix64 OneMinus = new Fix64(-1);
        public static readonly Fix64 Thousend = new Fix64(1000);
        /// <summary>
        /// The value of Pi
        /// </summary>
        ...
        public static readonly Fix64 Epsilon = new Fix64(1) / new Fix64(int.MaxValue);
        ...
        public static Fix64 Min(Fix64 max, Fix64 length)
        {
            if (max > length)
                return length;
            return max;
        }
        public static Fix64 Max(Fix64 max, Fix64 length)
        {
            if (max < length)
                return length;
            return max;
        ...
        public static Fix64 operator *(Fix64 x, Fix64 y)
        {
            ...
            {
                return opSignsEqual ? Maxue : MinValue;
            }
        ...
        public static Fix64 operator /(Fix64 x, Fix64 y)
        {
            ...
            while (remainder != 0 && bitPos >= 0)
            {
                ...
                {
                    return ((xl ^ yl) & MIN_VALUE) == 0 ? Maxue : MinValue;
                }
        ...
        {
            return x.m_rawValue == MIN_VALUE ? Maxue : new Fix64(-x.m_rawValue);
        }
        ...
        internal static Fix64 Pow2(Fix64 x)
        {
            ...
            if (x >= Log2Max)
            {
                return neg ? One / Maxue : Maxue;
            }
            if (x <= Log2Min)
            {
                return neg ? Maxue : Zero;
            }
        ...
        public static Fix64 DSin(Fix64 x)
        {
                var t = Sin(x * (Fix64.Pi / new Fix64(180)));
            return t;
        }

        public static Fix64 DCos(Fix64 x)
        {
            return Cos(x * (Fix64.Pi / new Fix64(180)));
        }
        /// <summary>
    ...
    partial struct Fix64 
    {
        ...
        {");
                ...
                for (int i = 0; i < LUT_SIZE; ++i)
                {
                    ...
                    if (tan > (double)Maxue || tan < 0.0)
                    {
                        tan = (double)Maxue;
                    }
                    var rawValue = (((decimal)tan > (decimal)Maxue || tan < 0.0) ? Maxue : (Fix64)tan).m_rawValue;
                    writer.Write(string.Format("0x{0:X}L, ", rawValue));
                }
                writer.Write(
@"
        ...
        {
            var newval = new Fix64((int)(value * 1000)) / new Fix64(1000);
            m_rawValue = newval.RawValue;
        }

        public static Fix64 FromRaw(long rawValue) {
            return new Fix64(rawValue, true);
        }
    }
}
